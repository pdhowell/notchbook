...
//import Foundation
//import SwiftUI
//import Combine // Essential for ObservableObject
//
//struct ShortcutItem: Identifiable, Codable {
//    var id = UUID()
//    var name: String
//    var iconName: String // SF Symbol name
//    var actionURL: String // URL scheme
//}
//
//class ShortcutManager: ObservableObject {
//    @Published var shortcuts: [ShortcutItem] = []
//    
//    // Define the key for saving data
//    private let storageKey = "savedShortcuts"
//    
//    init() {
//        loadShortcuts()
//        
//        // Add default shortcuts if the list is empty (first launch)
//        if shortcuts.isEmpty {
//            shortcuts = [
//                ShortcutItem(name: "Shazam", iconName: "sparkles", actionURL: "shortcuts://run-shortcut?name=Shazam"),
//                ShortcutItem(name: "Screenshot", iconName: "camera.viewfinder", actionURL: "screencapture -c")
//            ]
//            saveShortcuts() // Save defaults immediately
//        }
//    }
//    
//    func run(_ item: ShortcutItem) {
//        // 1. Try to open as URL (works for Shortcuts app, Websites, Deep links)
//        if let url = URL(string: item.actionURL) {
//            NSWorkspace.shared.open(url)
//        } else {
//            // Fallback for shell commands if you add that later
//            let task = Process()
//            task.launchPath = "/usr/bin/env"
//            task.arguments = ["bash", "-c", item.actionURL]
//            task.launch()
//        }
//    }
//    
//    func loadShortcuts() {
//        // Read directly from UserDefaults standard
//        if let data = UserDefaults.standard.data(forKey: storageKey) {
//            if let decoded = try? JSONDecoder().decode([ShortcutItem].self, from: data) {
...
//    
//    func saveShortcuts() {
//        // Write directly to UserDefaults standard
//        if let encoded = try? JSONEncoder().encode(shortcuts) {
//            UserDefaults.standard.set(encoded, forKey: storageKey)
//        }
//    }
//    
//    // Helper to add a new shortcut dynamically
//    func addShortcut(name: String, icon: String, command: String) {
//        let newItem = ShortcutItem(name: name, iconName: icon, actionURL: command)
